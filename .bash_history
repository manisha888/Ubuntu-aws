...
docker ps
docker ps -a
docker restart a3cc6fcff66d 
Docker attach a3cc6fcff66da3cc6fcff66d 
Docker attach a3cc6fcff66d
docker rukn -it --rm busybox echo "hello my friend"
ls
docker run -it --rm -v /home/manis/commands:/manis busybox sh
touch hello my friend.txt
ls
exit
#!/bin/bash
